...
- mock 登录支持三角色：见 `mock/data/devCredentials.ts` 与 [docs/engineering/dev-credentials.md](../../../docs/engineering/dev-credentials.md)。日常登录走 Nest；仅 `UMI_APP_NEST_AUTH=0` 且 `dev:mock` 时才会用这套账号。
