...
> 目标：在 `apps/user-web` 内完成后台运营台首版 CRUD、文档在线预览（PDF/Word）与公开阅读增强，仍使用 mock，为阶段 6 接入 NestJS 预留 service 契约。
...
实施范围来自 [../../../../docs/history/react-first-roadmap.md](../../../../docs/history/react-first-roadmap.md) 阶段 4，并吸收阶段 2–3 遗留项：
...
| 事项         | 结论                                                                            |
| ------------ | ------------------------------------------------------------------------------- |
| 工程         | 仍在 `apps/user-web`，不新建 admin 工程                                        |
| 后台 UI      | Ant Design Pro Layout + ProTable + ProForm                                      |
| 数据         | mock 为主；`services/admin/*` 与 future NestJS 路径对齐                         |
| PDF 预览     | **react-pdf**（见 `apps/user-web/src/config/documentViewers.ts`）              |
...
| 文档                                                                                           | 关系           |
| ---------------------------------------------------------------------------------------------- | -------------- |
| [../../../../docs/history/react-first-roadmap.md](../../../../docs/history/react-first-roadmap.md) | 阶段总览       |
...
| [../../../user-web/docs/implementation/phase-0-3.md](../../../user-web/docs/implementation/phase-0-3.md) | 已实现说明     |
