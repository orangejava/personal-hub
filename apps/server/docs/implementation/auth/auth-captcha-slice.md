...
> 状态：✅ 已落地
> 最后更新：2026-08-22
> 依据：[切片划分](./README.md)、[Canonical API](../../../../docs/backend/canonical-api.md) §2.1
...
- `apps/user-web/src/pages/user/login/index.tsx`
- `apps/user-web/src/services/auth.ts`：`createCaptchaChallenge`
