...
> 状态：✅ 已落地
> 最后更新：2026-08-22
> 依据：[切片划分](./README.md)、[Canonical API](../../../../docs/backend/canonical-api.md) §5.1、[治理 PRD](../../../../docs/prd/long-term/admin-governance-audit-prd.md)
...
- `apps/user-web/src/pages/admin/Users/index.tsx`
