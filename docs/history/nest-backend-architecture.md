# NestJS 后端整体架构（历史确认稿，待重写）

> 状态：🟡 部分过期；不得以本文的 Token、存储、AI、响应包装约定创建代码
> 最后更新：2026-08-02
...
│   ├── docker-compose.yml
│   └── server/Dockerfile
└── docs/history/nest-backend-architecture.md
```
...
详见原文档 §8 流程图；实现阶段以 `docs/backend/canonical-api.md` 为准。
