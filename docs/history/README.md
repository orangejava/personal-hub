...
> 当前后端实现入口：[Nest Server 脚手架 PRD](../prd/long-term/nest-server-bootstrap-prd.md)、[Canonical API](../backend/canonical-api.md)、[Canonical 数据模型](../backend/canonical-data-model.md)、[后端实现约定](../backend/conventions.md)。
