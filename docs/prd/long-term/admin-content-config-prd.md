...
> 最后更新：2026-06-09
> 优先级：P1
> 适用范围：`/admin/content/*`、`/admin/files`、`/admin/homepage`、`/admin/menus`、`/admin/system`
...
| 模块 | 接口 |
|---|---|
| 内容 | `GET /api/admin/contents`、`PATCH /api/admin/contents/:id/status`、`PATCH /api/admin/contents/:id/featured` |
| 文件 | `GET /api/admin/files`、`DELETE /api/admin/files/:id`、`DELETE /api/admin/files` |
| 首页 | `GET /api/admin/homepage`、`PUT /api/admin/homepage` |
| 菜单 | `GET /api/admin/menus`、`PATCH /api/admin/menus/:id`、`PATCH /api/admin/menus/sort` |
| 系统配置 | `GET /api/admin/system/config`、`PATCH /api/admin/system/config/:key`、`PUT /api/admin/system/config/batch` |
