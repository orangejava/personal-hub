...
- [../../operations/deployment.md](../../operations/deployment.md) — 长期 Docker / CI/CD
- [../../operations/server-deployment-guide.md](../../operations/server-deployment-guide.md) — 通用首次上线（本文 COS 方案取代其中 mock 预览路径）
- [../../backend/api.md](../../backend/api.md) — 正式 API 契约
- [../../backend/database.md](../../backend/database.md) — `content_chapters` 表结构
- [../phase-5-5-next-api-bridge-prd.md](../phase-5-5-next-api-bridge-prd.md) — 本文选择**直接最小 NestJS**，跳过 Next API Bridge
