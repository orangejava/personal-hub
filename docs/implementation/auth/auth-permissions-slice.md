...
> 状态：✅ 已落地
> 最后更新：2026-08-13
> 依据：[Auth/RBAC PRD](../../prd/long-term/auth-rbac-session-prd.md)、[Canonical API](../../backend/canonical-api.md)、[系统配置与菜单 PRD](../../prd/long-term/system-config-menu-prd.md)
...
- `apps/react-web/src/auth/routeRegistry.ts`：routeKey → 路径
- `apps/react-web/src/auth/mapNestPermissions.ts`：Nest → React access 兼容
